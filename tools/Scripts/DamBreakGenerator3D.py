...
def generate_fluid_particles(r, v, rho, p, itype, start_i):
    ...
    z_fluid_particles = params["z_fluid_particles"]
...
def generate_particles_data():
    ...
    params["nfluid"] = nfluid = x_fluid_particles * y_fluid_particles * z_fluid_particles
    ...
    r = numpy.zeros([3, ntotal], dtype=float)
    v = numpy.zeros([3, ntotal], dtype=float)
