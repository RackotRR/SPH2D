...
TEST_PARAMS_PRESENTED(SimulationParamsPresented, ExperimentDirectory::simulation_params_presented, SPH2DParams::filename)
...
TEST_F(ExperimentDirectoryTest, SatisfyPropertiesTestDir)
{
    ...
    test_dir.AddFile(SPH2DParams::filename);
